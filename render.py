...
flux_graph, nx_flux_graph = build_flux_graph(prob_graph, edgelist, paths)

vertified = add_vert_category(edgelist=flux_graph, log_reduction=log_reduction, height_scale=height_scale)

vert_pos = assign_vertical_positions(vertified)

vert_all = assign_vertical_edges(vert_pos, drop_length=drop_length, height_scale=height_scale)
...
surface = cairo.SVGSurface('graph.svg', scale_dict['WIDTH'], scale_dict['HEIGHT'])
